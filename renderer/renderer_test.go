	...
	tests := []struct {
	...
	}{
		{
			...
			want: strings.Join([]string{
				...
				`</ul>`,
				`<table>`,
				`<tr><td align="left">head 1</td><td align="center">head 2</td><td align="right">head 3</td></tr>`,
				`<tr><td align="left">body 1-1</td><td align="center">body 1-2</td><td align="right">body 1-3</td></tr>`,
				`<tr><td align="left">body 2-1</td><td align="center">body 2-2</td><td align="right">body 2-3</td></tr>`,
				`</table>`,
